			...
			<div className="message-container">
				...
				<div>
					...
					<p>
						...
						The "X" will go to a winner chosen randomly by the contract, "Y" and "Z" will be given away randomly by me as encentives for spreading the word on social media, and I will be holding onto the "E" token myself for the forseable future <span role="img">🤷</span>
					</p>
					<i>
						...
						So when you make your millions selling these tokens down the line you will still be supporting me <span role="img">😁</span> Thank you!
					</i>
				</div>
				<div className="winner">
					<h1>Who gets the X?</h1>
				...
				<i className="disclaimer">* if you do not want your public address displayed please contect me and I will remove it from the website.</i>
			</div>
		</div>
	)
}