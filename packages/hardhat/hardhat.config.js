...
module.exports = {
	...
	networks: {
		...
		rinkeby: {
			url: "https://rinkeby.infura.io/v3/0fd6448e8b89457c9eaa2d472eaca552", //<---- YOUR INFURA ID! (or it won't work)
			accounts: {
				mnemonic: mnemonic(),
			},
		},
		kovan: {
			url: "https://kovan.infura.io/v3/0fd6448e8b89457c9eaa2d472eaca552", //<---- YOUR INFURA ID! (or it won't work)
			accounts: {
				mnemonic: mnemonic(),
			},
		},
		mainnet: {
			url: "https://mainnet.infura.io/v3/0fd6448e8b89457c9eaa2d472eaca552", //<---- YOUR INFURA ID! (or it won't work)
			accounts: {
				mnemonic: mnemonic(),
			},
		},
		ropsten: {
			url: "https://ropsten.infura.io/v3/0fd6448e8b89457c9eaa2d472eaca552", //<---- YOUR INFURA ID! (or it won't work)
			accounts: {
				mnemonic: mnemonic(),
			},
		},
		goerli: {
			url: "https://goerli.infura.io/v3/0fd6448e8b89457c9eaa2d472eaca552", //<---- YOUR INFURA ID! (or it won't work)
			accounts: {
				mnemonic: mnemonic(),
			},
		},
	...
	etherscan: {
		...
		apiKey: "YW2QT6F6CP51XR2HJYN6GVYI7SFQM3392M"
	}
};
